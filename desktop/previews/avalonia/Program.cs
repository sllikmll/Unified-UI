...
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        {
            Console.WriteLine(JsonSerializer.Serialize(new { ok = true, app = "Unified UI Avalonia", version = Version, ui = "Avalonia", quality = "final-production", backend = "unified-ui-native-bridge", pages = QtPages, features = ProductionFeatures }));
            return 0;
        }
...
public sealed class MainWindow : Window
{
    ...
    public MainWindow()
    {
        Title = "Unified UI — Avalonia Final v0.5.0";
