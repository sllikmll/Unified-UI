...
def test_preview_manifest_lists_all_three_artifacts():
    ...
    assert 'Unified-UI-Avalonia-Final-0.5.0-win-x64.zip' in text
    assert 'Unified-UI-WPF-Final-0.5.0-win-x64.zip' in text
    assert 'Unified-UI-Cpp-Win32-Final-0.5.0-win-x64.zip' in text
