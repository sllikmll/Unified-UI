...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--version", default="2.6.8", help="Native product version")
    parser.add_argument("--tag", default="v2.6.8-native", help="GitHub release tag")
    parser.add_argument("--release-base-url", default="https://github.com/sllikmll/Unified-UI/releases/download/v2.6.8-native", help="Base URL for download links")
