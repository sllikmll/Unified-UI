...
RUN_SERVER = REPO_ROOT / "unified-ui" / "run_server.py"
...
def main() -> int:
    ...
    env.setdefault("UNIFIED_UI_STATE_DIR", str(STATE_DIR))
    env.setdefault("UNIFIED_LOG_DIR", str(LOG_DIR))
    env.setdefault("UNIFIED_UI_SECRET_KEY", "e2e-secret-key")
    env.setdefault("UNIFIED_UI_PORT", str(env.get("UNIFIED_E2E_PORT") or "18188"))
