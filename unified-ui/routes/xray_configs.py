...
def create_xray_configs_blueprint(
    *,
    ...
    def _restart_response(*, source: str, restart_flag: bool, extra: dict[str, Any] | None = None):
        ...
        payload["restarted"] = restart_flag and restart_unified(source=source)
...
# --- API: outbounds ---
    ...
    def api_xray_outbounds_proxies():
        ...
        if write_raw:
            try:
                raw_text = "// Generated by Unified UI (outbounds pool)\n" + json.dumps(
    ...
    def api_xray_observatory_preset():
        ...
        if existed_json:
            ...
            if not existed_jsonc:
                try:
                    ...
                    tpl_default = os.path.join(
                        (os.environ.get("UNIFIED_UI_STATE_DIR") or os.environ.get("UNIFIED_UI_DIR") or "/opt/etc/unified-ui"),
                        "templates", "observatory", "07_observatory_base.jsonc",
                    )
                    tpl_path = os.environ.get("UNIFIED_XRAY_OBSERVATORY_TEMPLATE", tpl_default)
            ...
            restarted = restart_flag and restart_unified(source="observatory-preset")
    ...
    def api_xray_observatory_generate():
        ...
        jsonc_text = (
            "// Автосгенерировано панелью Unified UI (leastPing)\n"
