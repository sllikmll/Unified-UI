"""Routes for running UnifiedUI commands in the background.
...
from services.unified_commands_catalog import ALLOWED_FLAGS, get_full_shell_policy, is_full_shell_enabled
