...
def _cfg_cache_ttl_s() -> int:
    # Default: 6 hours
    return max(60, _env_int("UNIFIED_UI_CORES_UPDATE_CACHE_TTL", 6 * 3600))


def _cfg_api_timeout_s() -> float:
    return max(2.0, _env_float("UNIFIED_UI_CORES_UPDATE_API_TIMEOUT", 6.0))
...
def create_cores_status_blueprint(ui_state_dir: str) -> Blueprint:
    ...
    def api_cores_updates() -> Any:
        ...
        xray_repo = str(os.environ.get("UNIFIED_UI_XRAY_REPO") or "XTLS/Xray-core")
        mihomo_repo = str(os.environ.get("UNIFIED_UI_MIHOMO_REPO") or "MetaCubeX/mihomo")
