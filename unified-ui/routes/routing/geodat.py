...
def _geodat_url_policy():
    return get_policy_from_env("UNIFIED_GEODAT")
...
def register_geodat_routes(bp: Blueprint) -> None:
    ...
    def api_geodat_install() -> Any:
        ...
        bin_path = _geodat_bin_path()
        env = os.environ.copy()
        env["UNIFIED_GEODAT_BIN"] = bin_path
        env["UNIFIED_GEODAT_INSTALL"] = "1"  # non-interactive
        env.setdefault("UNIFIED_GEODAT_TIMEOUT", os.getenv("UNIFIED_GEODAT_TIMEOUT", "25") or "25")
            ...
            if request.files and "file" in request.files:
                ...
                if f and getattr(f, "filename", ""):
                    ...
                    try:
                        ...
                        pass
                    env["UNIFIED_GEODAT_LOCAL"] = tmp_uploaded
            ...
            if url:
                ...
                try:
                    ...
                    try:
                        ...
                        pass
                    env["UNIFIED_GEODAT_LOCAL"] = tmp_downloaded
