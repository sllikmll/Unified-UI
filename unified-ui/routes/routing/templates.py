...
def register_templates_routes(
    ...
    *,
    ...
    # Routing templates should live OUTSIDE /opt/etc/xray so that Xray/unified
    ...
    try:
        ...
        _ui_state = os.environ.get("UNIFIED_UI_STATE_DIR") or os.environ.get("UNIFIED_UI_DIR") or "/opt/etc/unified-ui"

    routing_templates_dir = os.getenv(
        "UNIFIED_XRAY_ROUTING_TEMPLATES_DIR",
