...
def _geodat_error_payload(
    ...
    *,
    ...
    if payload["error"] == "missing_xk_geodat":
        ...
        payload["hint"] = "xk-geodat не ответил вовремя. Попробуйте ещё раз или увеличьте UNIFIED_GEODAT_TIMEOUT."
    ...
    try:
        ...
        if notice:
            try:
                ...
                resp.headers["X-UnifiedUI-Notice-B64"] = b64
                resp.headers["X-UnifiedUI-Notice-Kind"] = str(kind or "info")
            except Exception:
                pass
    except Exception:
        pass
