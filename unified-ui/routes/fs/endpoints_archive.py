...
def register_archive_endpoints(bp: Blueprint, deps: Dict[str, Any]) -> None:
    ...
    def api_fs_archive() -> Any:
        ...
        tmp_zip = os.path.join(TMP_DIR, f"unified_zip_selection_{uuid.uuid4().hex}.zip")
        ...
        try:
            ...
            tmp_root = os.path.join(TMP_DIR, f"unified_remote_zip_{uuid.uuid4().hex}")
    ...
    def api_fs_archive_create() -> Any:
        ...
        os.makedirs(TMP_DIR, exist_ok=True)
        tmp_out = os.path.join(TMP_DIR, f"unified_archive_create_{uuid.uuid4().hex}.tmp")
