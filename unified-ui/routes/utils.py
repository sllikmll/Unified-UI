...
def create_utils_blueprint() -> Blueprint:
    ...
    def api_format_jsonc():
        ...
        Response:
          {"ok": true, "text": "...", "engine": "unified_jsonc"|"json"}
        """
        ...
        try:
            ...
            return jsonify({"ok": True, "text": formatted, "engine": "unified_jsonc", "tabWidth": prefs["tabWidth"], "printWidth": prefs["printWidth"]}), 200
        except Exception:
