...
CONFIG_SERVER_BASE_ENV = "UNIFIED_CONFIG_SERVER_BASE"

# Seconds: how long to consider cached index "fresh".
_GH_INDEX_TTL = int(os.environ.get("UNIFIED_GITHUB_INDEX_CACHE_TTL", "60") or 60)
...
def github_raw_get(path: str) -> str | None:
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "unified-ui"}, method="GET")
    try:
