...
_HAPP_FALLBACK_UA_ENV = "UNIFIED_MIHOMO_HWID_HAPP_USER_AGENT"
_HAPP_FALLBACK_ENABLED_ENV = "UNIFIED_MIHOMO_HWID_HAPP_FALLBACK"
...
def _env_hwid_override() -> tuple[str | None, str | None]:
    for key in ("UNIFIED_MIHOMO_HWID", "UNIFIED_HWID"):
...
def _ui_state_dir() -> str:
    try:
        ...
        return str(UI_STATE_DIR or "").strip() or "/opt/etc/unified-ui"
    except Exception:
        return (
            os.environ.get("UNIFIED_UI_STATE_DIR")
            or os.environ.get("UNIFIED_UI_DIR")
...
def get_device_info() -> Dict[str, Any]:
    ...
    hwid_env_hint = (
        ...
        "UNIFIED_MIHOMO_HWID и нажмите Save. После этого заново нажмите «Проверить» "
...
_URL_POLICY_ENV_PREFIX = "UNIFIED_MIHOMO_HWID"
