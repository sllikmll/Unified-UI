...
Default router install location: /opt/etc/unified-ui/BUILD.json
...
def _candidate_paths(ui_state_dir: Optional[str] = None) -> List[str]:
    ...
    # hard router default
    paths.append("/opt/etc/unified-ui/BUILD.json")
...
def read_build_info(ui_state_dir: Optional[str] = None) -> Dict[str, Any]:
    ...
    env_repo = os.environ.get("UNIFIED_UI_UPDATE_REPO") or "sllikmll/Unified-UI"
    env_channel = os.environ.get("UNIFIED_UI_UPDATE_CHANNEL") or "stable"
