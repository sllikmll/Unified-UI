...
UI_MAX_CONTENT_LENGTH_ENV = "UNIFIED_UI_MAX_CONTENT_LENGTH"
JSON_BODY_MAX_BYTES_ENV = "UNIFIED_JSON_BODY_MAX_BYTES"
JSON_HEAVY_MAX_BYTES_ENV = "UNIFIED_JSON_HEAVY_MAX_BYTES"
MIHOMO_JSON_MAX_BYTES_ENV = "UNIFIED_MIHOMO_JSON_MAX_BYTES"
GEODAT_UPLOAD_MAX_BYTES_ENV = "UNIFIED_GEODAT_UPLOAD_MAX_BYTES"
ROUTING_SAVE_MAX_BYTES_ENV = "UNIFIED_ROUTING_SAVE_MAX_BYTES"
CONFIG_EXCHANGE_MAX_BYTES_ENV = "UNIFIED_CONFIG_EXCHANGE_MAX_BYTES"
REMOTEFM_MAX_UPLOAD_MB_ENV = "UNIFIED_REMOTEFM_MAX_UPLOAD_MB"
...
def classify_json_request_max_bytes(path: str, env: Optional[Mapping[str, Any]] = None) -> int:
    ...
    if p.startswith("/api/xray/") or p.startswith("/api/unified/"):
        return get_json_heavy_max_bytes(env)
...
def install_request_size_guards(app, *, env: Optional[Mapping[str, Any]] = None) -> None:
    ...
    The guard has two layers:
      - explicit Flask ``MAX_CONTENT_LENGTH`` ceiling for all request bodies;
        ...
        upload endpoints stream and enforce ``UNIFIED_REMOTEFM_MAX_UPLOAD_MB``;
