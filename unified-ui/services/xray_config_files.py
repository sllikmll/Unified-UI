...
#
# Supports env:
#   UNIFIED_XRAY_CONFIGS_DIR   — xray configs dir (default: /opt/etc/xray/configs)
#   UNIFIED_XRAY_JSONC_DIR     — UI sidecar dir for JSONC comments (default: <UI_STATE_DIR>/xray-jsonc)
#   UNIFIED_XRAY_ROUTING_FILE  — routing fragment file (auto-pick by default)
#   UNIFIED_XRAY_INBOUNDS_FILE — inbounds fragment file (auto-pick by default)
#   UNIFIED_XRAY_OUTBOUNDS_FILE— outbounds fragment file (auto-pick by default)
#   UNIFIED_XRAY_ROUTING_FILE_RAW — raw JSONC routing file (default: <routing>.jsonc)

_XRAY_CONFIGS_DIR_DEFAULT = os.path.join(BASE_ETC_DIR, "xray", "configs")
XRAY_CONFIGS_DIR = os.environ.get("UNIFIED_XRAY_CONFIGS_DIR", _XRAY_CONFIGS_DIR_DEFAULT)
...
XRAY_JSONC_DIR = os.environ.get("UNIFIED_XRAY_JSONC_DIR", _XRAY_JSONC_DIR_DEFAULT)
...
ROUTING_FILE = env_or_auto_pick("UNIFIED_XRAY_ROUTING_FILE", "05_routing.json", "05_routing_hys2.json")
INBOUNDS_FILE = env_or_auto_pick("UNIFIED_XRAY_INBOUNDS_FILE", "03_inbounds.json", "03_inbounds_hys2.json")
OUTBOUNDS_FILE = env_or_auto_pick("UNIFIED_XRAY_OUTBOUNDS_FILE", "04_outbounds.json", "04_outbounds_hys2.json")
...
try:
    _raw_override = os.environ.get("UNIFIED_XRAY_ROUTING_FILE_RAW", "")
