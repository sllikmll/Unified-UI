...
def init_auth(app) -> None:
    ...
    app.secret_key = os.environ.get("UNIFIED_UI_SECRET_KEY") or _load_or_create_secret_key()
    ...
    def _inject_auth_context():
        ...
        panel_sections = str(os.environ.get("UNIFIED_UI_PANEL_SECTIONS_WHITELIST") or "").strip()
        devtools_sections = str(os.environ.get("UNIFIED_UI_DEVTOOLS_SECTIONS_WHITELIST") or "").strip()
