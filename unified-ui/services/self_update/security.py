...
def parse_allow_hosts(raw: Optional[str] = None) -> List[str]:
    return parse_allow_hosts_shared(
        raw,
        env_key="UNIFIED_UI_UPDATE_ALLOW_HOSTS",
        default_hosts=DEFAULT_ALLOW_HOSTS,
    )


def is_http_allowed() -> bool:
    return env_flag("UNIFIED_UI_UPDATE_ALLOW_HTTP", False)
...
def security_snapshot() -> Dict[str, str]:
    ...
    return {
        ...
        "max_bytes": str(os.environ.get("UNIFIED_UI_UPDATE_MAX_BYTES") or "62914560"),
        "max_checksum_bytes": str(os.environ.get("UNIFIED_UI_UPDATE_MAX_CHECKSUM_BYTES") or "1048576"),
        "connect_timeout": str(os.environ.get("UNIFIED_UI_UPDATE_CONNECT_TIMEOUT") or "10"),
        "download_timeout": str(os.environ.get("UNIFIED_UI_UPDATE_DOWNLOAD_TIMEOUT") or "300"),
        "api_timeout": str(os.environ.get("UNIFIED_UI_UPDATE_API_TIMEOUT") or "10"),
        "sha_strict": str(os.environ.get("UNIFIED_UI_UPDATE_SHA_STRICT") or "1"),
        "require_sha": str(os.environ.get("UNIFIED_UI_UPDATE_REQUIRE_SHA") or "1"),
    }
