...
from services.unified import append_restart_log as _svc_append_restart_log

RESTART_LOG_FILE = os.environ.get("UNIFIED_RESTART_LOG_FILE", "/opt/etc/unified-ui/restart.log")
...
def generate_save_and_restart(payload: Dict[str, Any]) -> Tuple[str, str, List[str]]:
    """Generate config, save it and restart mihomo via unified.
