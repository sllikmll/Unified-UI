...
LEGACY_INIT_SCRIPT="/opt/etc/init.d/S99unified-ui"
INIT_SCRIPT="${UNIFIED_UI_INIT_SCRIPT:-$INIT_SCRIPT_DEFAULT}"
LOG_DIR="/opt/var/log/unified-ui"
CORE_LOG="$LOG_DIR/core.log"
ACCESS_LOG="$LOG_DIR/access.log"
WS_LOG="$LOG_DIR/ws.log"
RUN_PID="/opt/var/run/unified-ui.pid"
RESTART_LOG="/opt/etc/unified-ui/restart.log"
