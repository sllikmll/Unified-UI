...
SCAN_ROOTS_OVERRIDE="${UNIFIED_BACKUP_MONITOR_PATHS:-}"
LOCAL_BACKUP_DIR="${UNIFIED_LOCAL_BACKUP_DIR:-/opt/backups}"
XRAY_BACKUP_DIR="${UNIFIED_XRAY_BACKUP_DIR:-/opt/etc/xray/configs/backups}"
MIHOMO_ROOT_DIR="${MIHOMO_ROOT:-/opt/etc/mihomo}"
MIHOMO_BACKUP_DIR="${UNIFIED_MIHOMO_BACKUP_DIR:-$MIHOMO_ROOT_DIR/backup}"
