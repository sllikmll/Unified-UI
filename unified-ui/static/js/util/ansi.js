(() => {
  ...
  if (!UnifiedUI.util.ansiToHtml) {
    UnifiedUI.util.ansiToHtml = function ansiToHtml(text) {
      ...
      const esc = (typeof UnifiedUI.util.escapeHtml === 'function')
        ? UnifiedUI.util.escapeHtml(raw)
