...
(() => {
  ...
  async function confirmAction(options) {
    ...
    if (window.UnifiedUI && UnifiedUI.ui && typeof UnifiedUI.ui.confirm === 'function') {
      try { return !!(await UnifiedUI.ui.confirm(options || {})); } catch (e2) {}
    }
  ...
  function escapeHtml(s) {
    try {
      if (window.UnifiedUI && window.UnifiedUI.util && typeof window.UnifiedUI.util.escapeHtml === 'function') {
        return window.UnifiedUI.util.escapeHtml(String(s || ''));
      }
    } catch (e) {}
    return String(s || '')
      .replace(/&/g, '&amp;')
  ...
  function ansiToHtml(text) {
    try {
      if (window.UnifiedUI && window.UnifiedUI.util && typeof window.UnifiedUI.util.ansiToHtml === 'function') {
        return window.UnifiedUI.util.ansiToHtml(String(text || ''));
      }
    } catch (e) {}
