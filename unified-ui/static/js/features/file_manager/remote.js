...
(() => {
  ...
  const _LS_REMOTE_PROFILES_KEY = 'unified.fm.remoteProfiles.v1';
  const _LS_REMOTE_PROFILES_LAST_KEY = 'unified.fm.remoteProfiles.last.v1';
  // Remember "remember profile" checkbox state (UX: user doesn't have to re-check every time)
  const _LS_REMOTE_PROFILES_REMEMBER_FLAG_KEY = 'unified.fm.remoteProfiles.rememberFlag.v1';
