...
/*
  ...
  Inspired by UNIFIED_VLESS_Configurator_v3.py (forced rules section).
            ...
            <div class="xk-forced-wizard-grid">
              <section class="xk-forced-wizard-panel xk-forced-wizard-input-panel">
                ...
                <div class="xk-forced-editor-block">
                  ...
                  <textarea id="routing-forced-rules-values" class="unified-textarea" spellcheck="false" rows="7" placeholder="По одному на строке
example.com
domain:google.com
geosite:youtube
...
geoip:private"></textarea>
  ...
  async function saveWithForcedRestart() {
    ...
    if (routingApi && typeof routingApi.save === 'function') {
      const chk = document.getElementById('global-autorestart-unified');
