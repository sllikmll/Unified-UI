...
(function () {
  ...
  const FIELD_HELP_MODAL_ID = 'unified-routing-field-help-modal';
  const FIELD_HELP_TITLE_ID = 'unified-routing-field-help-title';
  const FIELD_HELP_BODY_ID = 'unified-routing-field-help-body';

  let _routingHelpWired = false;

  function getModalApi() {
    try {
      if (window.UnifiedUI && XK.ui && XK.ui.modal) return XK.ui.modal;
    } catch (e) {}
    return null;
  }
