...
import { getXkeenFilePath } from './unified_runtime.js';
...
(() => {
  ...
  const GROUPS_PREF_KEY = 'unified.mihomo.import.groups.v1';
  const GROUPS_REMEMBER_KEY = 'unified.mihomo.import.groups.remember_v1';
  const XRAY_INTERVAL_PREF_KEY = 'unified.mihomo.import.xray_interval_hours.v1';
  ...
  const MODE_PREF_KEY = 'unified.mihomo.import.mode.v1';
  ...
  function updateModeUi() {
    ...
    if (mode === 'wireguard') {
      ...
      inp.placeholder = 'hostname: unified\n# auth-key: tskey-auth-...\nstate-dir: ./tailscale\nudp: true\naccept-routes: true';
  ...
  function ensurePreviewCm() {
    ...
    try {
      ...
      w.classList.add('unified-cm', 'xk-mihomo-import-preview');
      if (typeof _previewCm.setSize === 'function') _previewCm.setSize(null, '100%');
