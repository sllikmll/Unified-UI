...
(() => {
  ...
  function apply(prefs) {
    ...
    try {
      document.dispatchEvent(new CustomEvent('unified-layout-change', { detail: { ...p } }));
    } catch (e) {}
  }
  ...
  // Currently: hide Files tab if RemoteFS is disabled (UNIFIED_REMOTEFM_ENABLE=0)
