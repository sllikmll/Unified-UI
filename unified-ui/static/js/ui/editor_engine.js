(() => {
  ...
  const LS_KEY = 'unified.editor.engine';

  const EVENT_NAME = 'unified-editor-engine-change';
  ...
  function getSettingsApi() {
    try {
      if (UnifiedUI.ui && UnifiedUI.ui.settings) return UnifiedUI.ui.settings;
    } catch (e) {}
    return null;
  }
  ...
  function isFacade(value) {
    try {
      return !!(value && value.__unifiedEditorFacade && isFn(value.get) && isFn(value.set));
    } catch (e) {}
    return false;
  }
  ...
  function getLazyApi() {
    try {
      return (window.UnifiedUI && UnifiedUI.runtime && UnifiedUI.runtime.lazy) ? UnifiedUI.runtime.lazy : null;
    } catch (e) {}
    return null;
  }
  ...
  function getMonacoLoader() {
    try {
      return (window.UnifiedUI && UnifiedUI.monacoLoader) ? UnifiedUI.monacoLoader : null;
    } catch (e) {}
    return null;
  }
  ...
  function getMonacoSharedApi() {
    try {
      return (window.UnifiedUI && UnifiedUI.ui && UnifiedUI.ui.monacoShared) ? UnifiedUI.ui.monacoShared : null;
    } catch (e) {}
    return null;
  }
  ...
  function get() {
    ...
    if (fromLocal) {
      _engine = fromLocal;
      // Keep settings cache consistent for consumers that read UnifiedUI.ui.settings.get()
  ...
  UnifiedUI.ui.editorEngine = UnifiedUI.ui.editorEngine || {};
  UnifiedUI.ui.editorEngine.EVENT = EVENT_NAME;
  UnifiedUI.ui.editorEngine.VALID = VALID.slice();
  UnifiedUI.ui.editorEngine.DEFAULT = DEFAULT_ENGINE;
  UnifiedUI.ui.editorEngine.get = get;
  UnifiedUI.ui.editorEngine.ensureLoaded = ensureLoaded;
  UnifiedUI.ui.editorEngine.set = set;
  UnifiedUI.ui.editorEngine.createFacade = createFacade;
  UnifiedUI.ui.editorEngine.fromCodeMirror = fromCodeMirror;
  UnifiedUI.ui.editorEngine.fromMonaco = fromMonaco;
  UnifiedUI.ui.editorEngine.fromTextarea = fromTextarea;
  UnifiedUI.ui.editorEngine.isFacade = isFacade;
  UnifiedUI.ui.editorEngine.RUNTIME_CONTRACT_VERSION = RUNTIME_CONTRACT_VERSION;
  UnifiedUI.ui.editorEngine.ensureSupport = ensureSupport;
  UnifiedUI.ui.editorEngine.getRuntime = getRuntime;
  UnifiedUI.ui.editorEngine.ensureRuntime = ensureRuntime;
  UnifiedUI.ui.editorEngine.isExperimentalCodeMirror6Enabled = isExperimentalCodeMirror6Enabled;
  UnifiedUI.ui.editorEngine.getCodeMirrorBackend = getCodeMirrorBackend;
  UnifiedUI.ui.editorEngine.onChange = onChange;
  UnifiedUI.ui.editorEngine.resetFallback = resetFallback;
  UnifiedUI.ui.editorEngine.cloneViewState = cloneViewState;
  UnifiedUI.ui.editorEngine.createViewStateStore = createViewStateStore;
