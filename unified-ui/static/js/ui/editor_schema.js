...
function isEditorExpertModeEnabled(ctx) {
  ...
  try {
    const api = window.UnifiedUI && window.UnifiedUI.ui && window.UnifiedUI.ui.settings;
...
function getRuntime(ctx) {
  ...
  try {
    return window.UnifiedUI && window.UnifiedUI.ui ? window.UnifiedUI.ui.cm6Runtime : null;
  } catch (e2) {}
  return null;
}
