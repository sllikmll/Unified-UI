(() => {
  ...
  //
  // Public API:
  //   UnifiedUI.ui.diff.registerScope({
  ...
  //   })
  //   UnifiedUI.ui.diff.unregisterScope(scope)
  //   UnifiedUI.ui.diff.getScope(scope)
  //   UnifiedUI.ui.diff.openForScope(scope, opts?)
  //   UnifiedUI.ui.diff.open({ left, right, language, title, ... })
  ...
  function registerScope(input) {
    ...
    try {
      document.dispatchEvent(new CustomEvent('unified:diff-scope-change', {
  ...
  function getModalApi() {
    try {
      if (UnifiedUI.ui && UnifiedUI.ui.diffModal && isFn(UnifiedUI.ui.diffModal.open)) return UnifiedUI.ui.diffModal;
    } catch (e) {}
    return null;
  }
  ...
  function logDiff(scopeKey, leftKind, rightKind) {
    ...
    try {
      ...
      try {
        const coreHttp = window.UnifiedUI && UnifiedUI.core && UnifiedUI.core.http;
  ...
  UnifiedUI.ui.diff = UnifiedUI.ui.diff || {};
  UnifiedUI.ui.diff.registerScope = registerScope;
  UnifiedUI.ui.diff.unregisterScope = unregisterScope;
  UnifiedUI.ui.diff.getScope = getScope;
  UnifiedUI.ui.diff.listScopes = listScopes;
  UnifiedUI.ui.diff.openForScope = openForScope;
  UnifiedUI.ui.diff.open = openRaw;
  UnifiedUI.ui.diff.resolveSourceText = resolveSourceText;
  UnifiedUI.ui.diff.applyTextToScope = applyTextToScope;
  UnifiedUI.ui.diff.describeSource = describeSource;
  UnifiedUI.ui.diff.logDiff = logDiff;
})();
