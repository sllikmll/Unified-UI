(() => {
  ...
  const scopes = (UnifiedUI.state.configDirtyScopes && typeof UnifiedUI.state.configDirtyScopes === 'object')
    ? UnifiedUI.state.configDirtyScopes
    : Object.create(null);
  UnifiedUI.state.configDirtyScopes = scopes;
  ...
  function emitScopeChange(scope, sourceName) {
    ...
    try {
      document.dispatchEvent(new CustomEvent('unified:config-dirty-change', { detail }));
    } catch (e) {}
  }
