...
(function () {
  ...
  const KEYS = {
    follow: 'unified_term_follow_v1',
    ansiFilter: 'unified_term_ansi_filter_v1',
    logHl: 'unified_term_log_hl_v1',
    fontSize: 'unified_term_font_size_v1',
    cursorBlink: 'unified_term_cursor_blink_v1',
  };
