...
(function () {
  ...
  const PREF_FONT_SIZE_KEY = 'unified_term_font_size_v1';
  const PREF_CURSOR_BLINK_KEY = 'unified_term_cursor_blink_v1';
    ...
    function createTerminal(opts = {}) {
      ...
      try {
        if (!typographyListener && typeof document !== 'undefined' && document && typeof document.addEventListener === 'function') {
          ...
          document.addEventListener('unified-typography-change', typographyListener);
        }
      } catch (e5) {}
      ...
      try {
        if (!themeListener && typeof document !== 'undefined' && document && typeof document.addEventListener === 'function') {
          ...
          document.addEventListener('unified-theme-change', themeListener);
        }
      } catch (e8) {}
    ...
    function disposeTerminal() {
      ...
      try {
        if (typographyListener && typeof document !== 'undefined' && document && typeof document.removeEventListener === 'function') {
          document.removeEventListener('unified-typography-change', typographyListener);
        }
      } catch (e0) {}
      ...
      try {
        if (themeListener && typeof document !== 'undefined' && document && typeof document.removeEventListener === 'function') {
          document.removeEventListener('unified-theme-change', themeListener);
        }
      } catch (e01) {}
      themeListener = null;
