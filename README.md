...
| Native desktop для macOS Apple Silicon | https://github.com/sllikmll/Unified-UI/releases/download/v2.5.7-native/Unified-UI-Native-2.5.7-arm64.dmg |
...
|---|---|---|
| macOS Apple Silicon | [Unified-UI-Native-2.5.7-arm64.dmg](https://github.com/sllikmll/Unified-UI/releases/download/v2.5.7-native/Unified-UI-Native-2.5.7-arm64.dmg) | Есть |
| Windows x64 | [Unified-UI-Native-2.5.7-x64.exe](https://github.com/sllikmll/Unified-UI/releases/download/v2.5.7-native/Unified-UI-Native-2.5.7-x64.exe) | Есть |
